...
- **Generated Protoblocks**: 17825
- **Cover Area**: 326.39 km²
- **Uncovered/Gap Area (Borders/Roads)**: 108.21 km²
- **Coverage Ratio**: 75.10%
- **Total Execution Time**: 165.67 seconds

## 2. Performance Metrics
| Stage | Provider | Duration (seconds) |
|---|---|---|
| Geocoding | OSMnx / Nominatim | 0.06 s |
| Data Fetching | protomaps | 120.06 s |
| Protoblock Generation | `generate_protoblocks` | 45.56 s |
| **Total** | | **165.67 s** |

## 3. Correctness & Geometry Analysis
The coverage ratio is **75.10%**. The remaining **108.21 km²** represents:
