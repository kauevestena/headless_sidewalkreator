...
def test_remove_dead_ends():
    ...
    gdf = gpd.GeoDataFrame(
        geometry=[line1, line2, line3, line4, line5], crs="EPSG:4326"
    )

    cleaned_gdf = remove_lines_from_no_block_gdf(gdf, iterations=1)

    # Iterative removal (1 iteration) prunes all leaf-touching edges; expect 1 remaining
